...
function FoodLog({ showInputs }) {
    ...
    const handleFoodSubmit = async (e) => {
        ...
        try {
            ...
            const payload = { food_name: foodName, calories: parseFloat(calories), entry_date: today };
    ...
    const deleteFoodEntries = async (foodEntryId) => {
        try {
            ...
            const updatedEntries = foodEntries.filter(entry => entry.entry_id !== foodEntryId);
    ...
    const editFoodEntries = async (foodEntryId, updatedFoodName, updatedCalories) => {
        try {
            const payload = { food_name: updatedFoodName, calories: parseFloat(updatedCalories) };
