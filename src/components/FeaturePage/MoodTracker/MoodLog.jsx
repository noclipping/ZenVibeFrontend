  ...
  return (
    <div className="mood-log-container">
      ...
      <p>
        ...
        to sadness, excitement, calmness, confusion, and more. By logging the intensity of your feelings on a
        scale from 1 to 10, you can better understand your emotional journey
        over time.
      </p>
